...
$(document).ready(function(){
  $("#hideImpactedObject").click(function(){
    $("tbody.tbody3").hide();
  });
  $("#showImpactedObject").click(function(){
    $("tbody.tbody3").show();
  });
  $("#hideMTComponents").click(function(){
    $("tbody.tbody5").hide();
  });
  $("#showMTComponents").click(function(){
    $("tbody.tbody5").show();
  });
});
</script>
...
<div class="grid-container">
  ...
  <div class="item2">
  <table class="tfmt2" style="width:100%;height:100%;align:center">
		<thead class="breakrow">
			<tr> 
  ...
  <div class="item3" style="width:100%;height:100%;align:center">
	<table class="tfmt3" style="width:100%;height:100%;align:center">
		...
		<button id="hideImpactedObject" style="margin:5px;">Hide Impacted Object Details</button>
		<button id="showImpactedObject" style="margin:5px;">Show Impacted Object Details</button>
		<tbody class="tbody3">
  ...
  <table class="tfmt5" style="width:100%;height:100%;align:center">
		<thead>
		<tr class='heading'> 
			 <th colspan="5" style="margin-top: 1px;margin-bottom: 1px;font-size:15px">Detail Report of Org Comparison</th> 
		</tr>
		</thead>	
		<button id="hideMTComponents" style="margin:5px;">Hide Metadata Components Details</button>
		<button id="showMTComponents" style="margin:5px;">Show Metadata Components Details</button>
		<tr>
